...
def test_getstationlist():
    ...
    #basic test
    #climate table
    assert_equal(dbObj.getStationList([-75.,44.],stationTable = "stations",climateStationBool = True),\
                    [['KSLK', 48.312,True], ['KART', 51.219,True], ['KMSS', 64.681,True]])
    #cliamte table with one record returned
    assert_equal(dbObj.getStationList([-75.,44.],1,stationTable = "stations",climateStationBool = True),\
                    [['KSLK', 48.312,True]])
                    
    #metar field
    assert_equal(dbObj.getStationList([-75.,44.]),\
                    [['KGTB', 36.089,False], ['KSLK', 48.312,True], ['KART', 51.219,True]])               
